...
class Tuple:
    ...
    def __str__(self):
        return str(self.bef_words + ' ' + self.bet_words + ' ' +
                   self.aft_words)
    ...
    def __hash__(self):
        return hash(str(self.bef_words + ' ' + self.bet_words + ' ' +
                   self.aft_words))
...
#                 if word not in self.config.stopwords]
        return [word for word in text.lower().split(" ") if word not in self.config.stopwords]
